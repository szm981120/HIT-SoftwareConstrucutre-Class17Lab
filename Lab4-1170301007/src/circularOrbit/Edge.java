...
public class Edge<E> {
	 ...
	 * 	E(type) is immutable according to spec so all reps are immutable.
	 */
	 ...
	 * @param w weight of this edge, must be a decimal greater than 0 and no more
	 *          than 1.
	 */
	...
	public boolean equals(Object obj) {
		return obj != null && obj.getClass() == Edge.class && ((Edge<E>) obj).getSource().equals(this.source)
				&& ((Edge<E>) obj).getTarget().equals(this.target);
	}

	/**
	 * Because the equality of edges links with equality of source and target, hash
	 * code of edge should be a particular combination of source's and target's hash
	 * code.
	 */
	@Override
	public int hashCode() {
