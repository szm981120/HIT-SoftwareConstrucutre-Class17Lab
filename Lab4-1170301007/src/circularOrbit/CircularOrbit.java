...
public interface CircularOrbit<L, E> extends Iterable<E> {
	...
	/**
	 * Mutator. Add a relationship between physicalObject A and physicalObject B
	 * with a intimacy of weight. This method should only perform in circular orbit
	 * with relationship.
	 * 
	 ...
	 * @throws AtomElectronNumException            This exception is about electron
	 *                                             number in atom structure. This
	 *                                             includes that data doesn't
	 *                                             indicate electron number for some
	 *                                             tracks, number of track doesn't
	 *                                             match the number of electron.
	 *                                             information.
	 * @throws AtomTrackNumException               This exception is about track
	 *                                             number in atom structure. The
	 *                                             number of track is not positive
	 *                                             integer in data file.
	 * @throws AtomElementException                This exception is about nucleus
	 *                                             element in atom structure. This
	 *                                             includes that element of atom
	 *                                             contains 0 or more than 2
	 *                                             characters, the first character
	 *                                             is not a upper case character, or
	 *                                             the second character is not a
	 *                                             lower case character.
	 * @throws IOException                         This exception may happen when
	 *                                             read file with BufferedReader.
	 * @throws NumberFormatException               This exception may happen like
	 *                                             when parameter in
	 *                                             Integer.parseOf() doesn't match
	 *                                             format.
	 * @throws DataSyntaxException                 This exception is about data in
	 *                                             file may doesn't fit syntax in
	 *                                             specification. When this
	 *                                             exception happens, it means some
	 *                                             components in format data fail to
	 *                                             match regular expression.
	 * @throws DataScientificNumberException       This exception is about illegal
	 *                                             scientifc number notation. This
	 *                                             includes that the mantissa is not
	 *                                             between 1 and 10 or the exponent
	 *                                             is less than 4.
	 * @throws IllegalIntimacyInSocialTieException This exception may happens only
	 *                                             in social network circle. When
	 *                                             this exception happens, it means
	 *                                             the intimacy of a social tie is
	 *                                             no more than 0 or greater than 1.
	 */
