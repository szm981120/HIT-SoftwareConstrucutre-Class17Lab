...
public class Star {
	 ...
	 * 	AF(name) = the name of this star.
	 * 	AF(radius) = the radius of this star.
	 ...
	 * 	All representation in Observer are immutable.
	 */
	...
	public boolean equals(Object star) {
		return star != null && star.getClass() == this.getClass() && ((Star) star).getName().equals(this.name);
	}

	/**
	 * Because equality of stars only links with name, hash code of star can be
	 * defined as it's name's hash code.
	 */
	@Override
	public int hashCode() {
