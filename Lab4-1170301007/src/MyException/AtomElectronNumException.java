...
/**
 * This exception is about electron number in atom structure. This includes that
 * data doesn't indicate electron number for some tracks, number of track
 * doesn't match the number of electron.
 * 
 * @author Shen
 *
 */
