...
/**
 * This exception is about data in file may doesn't fit syntax in specification.
 * When this exception happens, it means some components in format data fail to
