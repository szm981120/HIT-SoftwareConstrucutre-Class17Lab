...
public class Planet implements PhysicalObject {
	 ...
	 * Constructor.
	 * 
	 * @param name   planet's name, must be consist of only letters or numbers and
	 *               mustn't contain any blank space or any other characters.
	 * @param state  planet's state, must be consist of only letters or numbers and
	 *               mustn't contain any blank space or any other characters.
	 * @param color  planet's color, must be consist of only letters or numbers and
	 *               mustn't contain any blank space or any other characters.
	 * @param radius planet's radius, must be positive, unit is kilometer.
	 * @param speed  planet's speed, must be non-negative, unit is kilometer per
	 *               second.
	 * @param direct planet's revolution direction, true if it's clockwise, false if
	 *               it's counter-clockwise.
	 * @param degree planet's degree, must be no less than 0 and less than 360, unit
	 *               is degree.
	 */
	...
	public boolean equals(Object planet) {
		return planet != null && planet.getClass() == Planet.class && this.name.equals(((Planet) planet).name);
	}
