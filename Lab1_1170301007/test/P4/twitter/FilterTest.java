...
public class FilterTest {
    ...
    private static final Tweet tweet3 = new Tweet(3, "jackma", ":I @jackMa don't like money much @Wangjianlin", d3);
    ...
    public void testWrittenByMultipleTweetsSingleResult() {
        ...
        List<Tweet> jackma = Filter.writtenBy(Arrays.asList(tweet1, tweet2, tweet3), "jackMA");
        
        assertEquals("expected singleton list", 1, writtenBy.size());
        assertTrue("expected list to contain tweet", writtenBy.contains(tweet1));
        assertTrue("expected list to contain tweet", jackma.contains(tweet3));
    }
