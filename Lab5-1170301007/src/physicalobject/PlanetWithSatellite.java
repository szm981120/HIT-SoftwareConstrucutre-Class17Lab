...
public class PlanetWithSatellite extends SatelliteDecorator {
  ...
  /*
   * Abstraction function: AF(satellites) = a list of satellites which the mother planet has
   * 
   ...
   * 
   * @param planet the mother planet
   */
  ...
  public String getState() {
    return this.planet.getState();
  }

  @Override
  public String getColor() {
    return this.planet.getColor();
  }

  /**
   * When a plant is decorated by this class, it means this planet is added a satellite, so this
   * method should be called in constructor when a planet is decorated by this class.
   */
